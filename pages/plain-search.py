...
from utils import query_elastic_by_single_field, get_elastic_client, build_search_metadata,add_to_search_history
...
def search_elastic(searchterm: str, 
                     field_name = "text", 
